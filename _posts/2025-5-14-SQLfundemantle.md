...
<p dir="rtl" style=" font-size: 20px; line-height: 1.6;">
    ...
    وحتى اقدر خلي ال Web Application يكون dynamic لازم خليه يتواصل مع قاعدة البيانات يلي عندي.<br>
...
<p dir="rtl" style=" font-size: 20px; line-height: 1.6;">
الفكرة هون انو اذا بستخدم المعلومات يلي بيعطيني ياها المستخدم حتى ابني query لقاعدة البيانات تبعي رح يصير عندي كتير مشاكل، لانو ممكن الهكر بكل بساطة يستخدم هي ال query ويعدل شوي عليها عليها ليستخدمها بشي تاني تماما او ليحاول يوصل لقواعد بيانات ما لازم يكون عنده وصول عليها وهاد الشي اسمه هجوم ال SQL Injection.<br><br>
يعني اتخيل معي اي شي بيعطيني ياه المستخدم بروح بحطه بال query تبعي بدون ما اتأكد منه، بقوم الهاكر بضيف اوامر جديدة عال query متل انه ياخد اسماء وكلمات السر تبع كل المستخدمين 🫠<br> ولقدام شوي رح نشوف كيف ممكن نعمل هالشي بأيدنا😈<br><br>
...
<p dir="rtl" style=" font-size: 20px; line-height: 1.6;">
      ...
      بصير عندي ال SQL Injection لما المستخدم بحط مدخلات بتغير بال query يلي بدو يبعتها الويب لقاعدة البيانات وهالشي بخلي المستخدم ينفذ quries غير يلي لازم تتنفذ متل ماشرحنا سابقاً.<br><br>
      ...
      وحدة من الطرق البسيطة هي ادخال single quote (‘) أو double quote (“)، وهالشي مشان اتأكد اذا عم يتم تنفيذ اي شي بدخله بال query مباشرة ولا عم يتم تنظيفه.<br>
...
<p dir="rtl" style=" font-size: 20px; line-height: 1.6;">
      وهاد الشي برجع خطأ وهيك بعرف انه الموقع ما براقب المدخلات قبل ما يضيفها عال query
      <br><br>
...
<p dir="rtl" style="font-size: 20px; line-height: 1.6;">
    قبل ما نتعلم ال Sql Injection بدنا نتعلم شوي عن ال SQL، يعني اكيد حتى نقدر نعدل على الquery لازم نعرف عالقليلة نقرأها ونفهمها صح🌚.<br>
    في انواع كتير ومتنوعة من قواعد البيانات ولكل نوع استخدام غير التاني، كانت التطبيقات سابقاً بتستخدم قواعد بيانات بتخزن ال Data بملفات وهاد الشي كان بطيء كتير لما يصير عندي كمية كبيرة من الData وهاد الشي يلي جعل الكل يعتمد على ال Database Managment System(DBMS).<br>
</p>
---
...
<p dir="rtl" style="font-size: 20px; line-height: 1.6;">
    ال Database Managment System(DBMS) هو عبارة عن نظام بساعدني على إنشاء قواعد البيانات وتعريفها وحتى إستضافتها كمان.<br>
    ...
    ورح نتعامل معه كتير لاحقاً، ونفهمه بشكل معمق.
</p>
...
<br>
    ...
    اسمها ال Frontend بتتكون عادة من الجانب الخاص بالمستخدم، متل مواقع الويب والواجهات الرسومية او حتى الصور والألوان وبتكون غالباً تفاعلية يعني فيها صفحة تسجيل دخول ومكان للتعليقات والبيانات يلي مندخلها بتنتقل للبنية التانية عن طريق شي اسمو API او Requests تانية.<br><br>
    <span style="font-family: 'Amiri'; color:rgb(138, 201, 38); font-size: 20px; line-height: 1.6;">البنية الثانية:</span>
    اسمها ال Backend، وهي المسؤولة عن تفسير البيانات يلي بتجيني من الطبقة الاولى وتجهيزها بالشكل يلي بيقبله ال DBMS.<br>
    ...
    بعدين برجع ال DBMS البيانات المطلوبة او الاخطاء يلي بتطلع عندي اذا كان في Queries غير صحيحة.<br>
</p>
